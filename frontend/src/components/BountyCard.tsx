...
export function BountyCard({ bounty, onClick }: Props) {
  ...
  return (
    <div
      ...
      className="flex flex-col justify-between h-full rounded-xl bg-[#040406] border border-white/10 p-5 cursor-pointer hover:border-teal-500/30 hover:scale-[1.01] transition-all duration-300 shadow-lg"
    >
      <div className="flex flex-col h-full w-full">
        ...
        <h3 className="font-medium mb-3 text-sm leading-relaxed">
          <a
            ...
            className="text-white hover:text-teal-300 transition-colors line-clamp-2"
        ...
        <div className="space-y-2.5 text-xs text-gray-400 mb-4 flex-1">
          <div className="flex items-center gap-2.5 group/item hover:text-gray-300 transition-colors">
            <svg className="w-4 h-4 text-gray-500 flex-shrink-0 group-hover/item:text-teal-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
