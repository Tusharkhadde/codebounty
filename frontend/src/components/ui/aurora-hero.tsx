...
export function AuroraHero({
  ...
  return (
    <section
      className={cn("aurora-hero-wrapper w-full min-h-[400px] h-[500px] sm:h-[600px] relative overflow-hidden rounded-3xl", className)}
      {...props}
    >
      <style>{`
        .aurora-hero-wrapper {
      ...
      <div className="aurora-content z-10 px-4">
        {title && <h1 className="h1-scalingSize" data-text={title}>{title}</h1>}
        <div className="mt-8 z-20 invert filter-none text-black flex flex-col items-center">
          {children}
        </div>
      </div>
